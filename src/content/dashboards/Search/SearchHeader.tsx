        ...
        <div className="search-container">
          <div className="container-margin">
            <div className="fileMargin">
              <img src="/static/images/files_icon.png" className="fileImage" />
              <p className="filepara">42 files</p>
            </div>
          </div>
          <div className="pl-4">
            <div className="pagesContainer">
              <img src="/static/images/pages_icon.png" className="pagesIcon" />
              <p className="pagesPara">Search terms found 2107 times</p>
            </div>
          </div>
        </div>
      </Box>
